...
export { DEFAULT_BASE_WIDGETS, BlankLine, DividingParagraph, Italics, Strong } from '@specify-text/react';
export type { BlankLineProps, DividingParagraphProps, ItalicsProps, StrongProps } from '@specify-text/react';
